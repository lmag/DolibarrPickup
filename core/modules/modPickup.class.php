...
class modPickup extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->url_last_version = 'https://johnxlivingston.github.io/DolibarrPickup/latest_version.txt';
        ...
        $this->tabs[] = array(
            'data' => 'productlot:+pickups:Pickups:pickup@pickup:$user->rights->pickup->read:/pickup/tabs/productlot_pickups.php?id=__ID__'
        );
        // Example:
        ...
        */
        ...
        $r++;
        $this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Correct Data';	// Permission label
        $this->rights[$r][4] = 'correctdata';				// In php code, permission will be checked by test if ($user->rights->pickup->level1->level2)
        $this->rights[$r][5] = '';				    // In php code, permission will be checked by test if ($user->rights->pickup->level1->level2)
        $r++;
        $this->rights[$r][0] = $this->numero + $r;	// Permission id (must not be already used)
        $this->rights[$r][1] = 'Import / Export';	// Permission label
        $this->rights[$r][4] = 'importexport';				// In php code, permission will be checked by test if ($user->rights->pickup->level1->level2)
        $this->rights[$r][5] = '';				    // In php code, permission will be checked by test if ($user->rights->pickup->level1->level2)
        $r++;
        /* END PERMISSIONS */
        ...
        $this->menu[$r++]=array(
            'fk_menu'=>'fk_mainmenu=pickup',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type'=>'left',			                // This is a Left menu entry
            'titre'=>'PickupMenuCorrectData',
            'mainmenu'=>'pickup',
            'leftmenu'=>'pickup_correctdata',
            'url'=>'/pickup/correctdata/correctdata.php',
            'langs'=>'pickup@pickup',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position'=>1100+$r,
            'enabled'=>'$conf->pickup->enabled',  // Define condition to show or hide menu entry. Use '$conf->pickup->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            ...
            'user'=>0);				                // 0=Menu for internal users, 1=external users, 2=both
        $this->menu[$r++]=array(
            'fk_menu'=>'fk_mainmenu=pickup,fk_leftmenu=pickup_correctdata',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type'=>'left',			                // This is a Left menu entry
            'titre'=>'PickupMenuCorrectDataProductStatusBatch',
            'mainmenu'=>'pickup',
            'leftmenu'=>'pickup_correctdata_psb',
        ...
        $this->menu[$r++]=array(
            'fk_menu'=>'fk_mainmenu=pickup,fk_leftmenu=pickup_correctdata',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type'=>'left',			                // This is a Left menu entry
            'titre'=>'PickupMenuCorrectDataBatchNumber',
            'mainmenu'=>'pickup',
            'leftmenu'=>'pickup_correctdata_mbn',
            'url'=>'/pickup/correctdata/missing_batch_number.php',
            'langs'=>'pickup@pickup',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position'=>1100+$r,
            'enabled'=>'$conf->pickup->enabled && $conf->productbatch->enabled',  // Define condition to show or hide menu entry. Use '$conf->pickup->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'perms'=>'$user->rights->pickup->correctdata',               // Use 'perms'=>'$user->rights->pickup->level1->level2' if you want your menu with a permission rules
            'target'=>'',
            'user'=>0);				                // 0=Menu for internal users, 1=external users, 2=both
        $this->menu[$r++]=array(
            'fk_menu'=>'fk_mainmenu=pickup',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type'=>'left',			                // This is a Left menu entry
            'titre'=>'PickupMenuImportExport',
            'mainmenu'=>'pickup',
            'leftmenu'=>'pickup_importexport',
            'url'=>'/pickup/importexport.php',
            'langs'=>'pickup@pickup',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position'=>1100+$r,
            'enabled'=>'$conf->pickup->enabled && (!empty($conf->global->PICKUP_USE_PCAT) || !empty($conf->global->PICKUP_IMPORTEXPORT_ALL))',  // Define condition to show or hide menu entry. Use '$conf->pickup->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'perms'=>'$user->rights->pickup->importexport',               // Use 'perms'=>'$user->rights->pickup->level1->level2' if you want your menu with a permission rules
            'target'=>'',
            'user'=>0);				                // 0=Menu for internal users, 1=external users, 2=both
        $this->menu[$r++]=array(
            'fk_menu'=>'fk_mainmenu=pickup',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
